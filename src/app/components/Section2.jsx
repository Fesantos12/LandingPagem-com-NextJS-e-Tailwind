...
import Picture2 from "@/app/img/Picture2.png"
        ...
        <div className="w-full flex flex-col items-start gap-6 max-lg:items-center">
            <div className="w-full h-[220px] flex items-start justify-start max-lg:justify-center">
                <Image
                    ...
                    height={220}
                />
                <div className="absolute mt-3 ml-3 px-1 py-2 bg-purple-100 rounded text-sm font-normal leading-[140%] text-purple-800">Festival</div>
            </div>
            <div className="flex flex-col gap-2">
                <h4 className="text-base font-normal leading-[110%] text-gray-900">Festival</h4>
                <h2 className="text-[40px] font-bold leading-[110%] text-gray-900">Music & Colors</h2>
            </div>
