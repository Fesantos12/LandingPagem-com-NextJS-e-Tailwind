    ...
    return (
        <div className="w-full p-20 flex items-center gap-20 max-lg:flex-wrap-reverse justify-center">
            <div className="w-3/6 flex flex-col items-start gap-4 max-lg:items-center">
                <h3 className="text-xl font-bold leading-[100%] tracking-[3px] text-white">SPEED</h3>
                <h2 className="text-[56px] leading-[110%] font-extrabold text-white max-lg:text-center">Work fast, w/o <br /> interruptions</h2>
